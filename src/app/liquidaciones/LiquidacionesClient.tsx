                  ...
                  {planillasFiltradas.map((planilla) => (
                    <label
                      ...
                      className={`flex items-center p-3 rounded border cursor-pointer transition-colors ${
                        planillasSeleccionadas.includes(planilla.id) 
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-sm text-gray-600 mt-1">
                          <span className="font-medium">{planilla.vehiculos?.codigo_vehiculo}</span> • 
                          {planilla.conductor} • 
                      ...
                      <p className="font-bold text-lg text-gray-900 ml-3">
                        ${planilla.valor.toLocaleString('es-CO')}
                      </p>
                    </label>
                  ))}
                </div>
                    ...
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-xs text-gray-600 mt-1">
                          {planillasSeleccionadas.length} planilla(s) seleccionada(s)
                        </p>
                      </div>
                      <button
                        onClick={handleCrearLiquidacion}
                        disabled={loading}
                        className="bg-blue-600 text-white px-8 py-3 rounded-lg hover:bg-blue-700 disabled:opacity-50 font-semibold shadow-lg"
                      >
