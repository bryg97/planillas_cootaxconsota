        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <form onSubmit={handleSubmitConfig}>
              ...
              <div className="mb-4">
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Valor por Hora (Calculadora)
                </label>
                <input
                  type="number"
                  name="valor_hora_calculadora"
                  step="1"
                  defaultValue={configuracion?.valor_hora_calculadora || 30000}
                  className="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                  placeholder="30000"
                />
              </div>
              ...
              <div className="mb-4">
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Valor por Minuto (Calculadora)
                </label>
                <input
                  type="number"
                  name="valor_minuto_calculadora"
                  step="1"
                  defaultValue={configuracion?.valor_minuto_calculadora || 500}
                  className="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
                  placeholder="500"
                />
              </div>
